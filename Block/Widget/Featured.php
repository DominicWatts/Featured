...
namespace Xigen\Featured\Block\Widget;

/**
 * Featured Widget class
 */
class Featured extends \Magento\Catalog\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    {
        return $this->_getFeaturedProductsCollection();
    }
    ...
    protected function _getFeaturedProductsCollection()
    {
        ...
        $collection = $this->_addProductAttributesAndPrices($collection)
            ...
            ->addAttributeToFilter('featured', ['eq' => 1])
        ...
        if ($this->showPager()) {
            if (!$this->_pager) {
                $this->_pager = $this->getLayout()->createBlock(
                    ...
                    'widget.featured.product.list.pager'
                );
